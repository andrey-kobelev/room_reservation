...
За счёт интеграции с Google APIв проекте есть возможность формировать отчёт в гугл-таблицу с количеством бронирований каждой переговорки за указанный период.
